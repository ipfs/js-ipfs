...
## [0.12.0](https://www.github.com/ipfs/js-ipfs/compare/ipfs-message-port-client-v0.11.0...ipfs-message-port-client-v0.12.0) (2022-01-27)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * ipfs-message-port-protocol bumped from ^0.11.0 to ^0.12.0
  * devDependencies
    * interface-ipfs-core bumped from ^0.154.0 to ^0.155.0
    * ipfs-core bumped from ^0.14.0 to ^0.15.0
    * ipfs-message-port-server bumped from ^0.11.0 to ^0.12.0
