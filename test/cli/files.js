...
=======
    return ipfs('add test/fixtures/test-data/hello --cid-base=base32')
      .then((out) => {
        expect(out).to.eql('added bafybeicg2rebjoofv4kbyovkw7af3rpiitvnl6i7ckcywaq6xjcxnc2mby hello\n')
>>>>>>> feat: add cid-base option for files.add*
      })
  })
