...
describe('name', function () {
  ...
  describe('working locally', function () {
    ...
    it.only('should publish and then resolve correctly with the default options', function (done) {
      publishAndResolve(node, node, ipfsRef, { resolve: false }, nodeId, { nocache: true }, done)
    })
